...
import { GetEmployeeEmployeeData } from "./getEmployee";
import { CalculatePayrollEmployeeData } from "./calculatePayroll";

export default interface EmployeeData extends GetEmployeeEmployeeData, CalculatePayrollEmployeeData {
